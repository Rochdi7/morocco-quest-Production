                ...
                <div class="col-12">
                    <div class="breadcrumb-content">
                        ...
                        <figcaption class="image-caption visually-hidden">
                            Hot air balloons floating over the Moroccan desert with off-road vehicles parked below at
                            sunrise, offering a unique adventure experience.

                        </figcaption>

                        <p class="visually-hidden">
                            Enjoy a magical hot air balloon ride over the beautiful Moroccan desert at sunrise, capturing
                            breathtaking views and unique memories.
                        </p>
                    </div>
                </div>
            </div>
                                ...
                                <div class="tour-package-footer d-flex justify-content-between align-items-center">
                                    ...
                                    @if (isset($tour->price_adult))
                                        <div class="pricing-info text-end">
                                            ...
                                            <span class="fs-xs d-block">Price On Request</span>
                                        ...
                                        <li class="date">
                                            @if ($blog->created_at)
                                                <div class="vs-blog-date">
                                                    <span
                                                        class="date-number">{{ \Carbon\Carbon::parse($blog->created_at)->format('d') }}</span>
                                                    <span
                                                        class="date-month">{{ \Carbon\Carbon::parse($blog->created_at)->format('M') }}</span>
                                                </div>
                                            @endif
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="custom-ul blog-share">
                                        <li>
                                            ...
                                            <ul class="custom-ul share-list">
                                                <li><a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('blog.show', $blog->slug)) }}"
                                                        class="facebook" target="_blank"
                                                        aria-label="Share on Facebook"><i
                                                            class="fa fa-brands fa-facebook"></i></a></li>
                                                <li><a href="https://twitter.com/intent/tweet?url={{ urlencode(route('blog.show', $blog->slug)) }}&text={{ urlencode($blog->title) }}"
                                                        class="twitter" target="_blank" aria-label="Share on Twitter"><i
                                                            class="fa fa-brands fa-twitter"></i></a></li>
                                                <li><a href="https://pinterest.com/pin/create/button/?url={{ urlencode(route('blog.show', $blog->slug)) }}&media={{ urlencode($featuredImage) }}&description={{ urlencode($blog->title) }}"
                                                        class="pinterest" target="_blank"
                                                        aria-label="Share on Pinterest"><i
                                                            class="fa-brands fa-pinterest"></i></a></li>
                                                <li><a href="https://www.instagram.com/?url={{ urlencode(route('blog.show', $blog->slug)) }}"
                                                        class="instagram" target="_blank"
                                                        aria-label="Share on Instagram"><i
                                                            class="fa-brands fa-instagram"></i></a></li>
                                                <li><a href="https://www.tiktok.com/upload?url={{ urlencode(route('blog.show', $blog->slug)) }}"
                                                        class="tiktok" target="_blank" aria-label="Share on TikTok"><i
