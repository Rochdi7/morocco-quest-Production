...
@endpush
    ...
    <meta property="og:title" content="About Us - Morocco Quest Travel Agency" />
    <meta property="og:description" content="Discover Morocco Quest, your authentic gateway to Moroccan adventures with a mission for immersive & sustainable travel." />
    <meta property="og:image" content="{{ asset('assets/img/about/about-thumb.png') }}" />
    <meta property="og:url" content="{{ url()->current() }}" />
    <meta property="og:type" content="website" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="About Us - Morocco Quest Travel Agency" />
    <meta name="twitter:description" content="Discover Morocco Quest, your authentic gateway to Moroccan adventures with a mission for immersive & sustainable travel." />
    <meta name="twitter:image" content="{{ asset('assets/img/about/about-thumb.png') }}" />
    ...
    <script type="application/ld+json">
    {
        ...
        "url": "{{ url()->current() }}",
        "description": "Morocco Quest is your authentic gateway to Moroccan adventures. We are passionate about providing immersive experiences with expert guides and a commitment to sustainable tourism.",
        "image": "{{ asset('assets/img/about/about-thumb.png') }}",
...
@section('content')
    <section class="vs-breadcrumb" data-bg-src="{{ asset('assets/img/chefchaouen-morocco-blue-city-panorama-hero.webp') }}">
        ...
        <img src="{{ asset('assets/img/icons/ballon-sclation.png') }}" alt="Decorative hot air balloon icon"
            class="vs-breadcrumb-icon-2 animate-parachute" loading="lazy" width="60" height="75">
        <div class="container">
                ...
                <div class="col-12">
                    <div class="breadcrumb-content">
                        ...
                        <p class="visually-hidden">
                            ...
                            natural beauty make it a symbol of serenity, tradition, and cultural richness—perfectly
                            representing Morocco Quest’s spirit of Moroccan authenticity and warmth.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="vs-about position-relative space">
        <img src="{{ asset('assets/img/icons/plain-globe.png') }}" alt="Decorative globe icon"
            class="about-icon-1 animate-parachute" loading="lazy" width="100" height="100">
                    ...
                    <div class="about-info-area">
                        ...
                        <div class="about-info">
                            <p>
                                ...
                                Founded by Mounir Akajia in 2022, a travel enthusiast and avid explorer, our mission is to
                                provide authentic, immersive, and memorable experiences.
                                ...
                                <ul class="custom-ul">
                                    <li>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="16"
                                            viewBox="0 0 18 16" fill="none" aria-hidden="true">
                                            <path
                            ...
                            <div class="btn-trigger btn-bounce">
                                <a href="{{ route('tours.index') ?? '#' }}" class="vs-btn style6 text-capitalize">Explore
                                    Our Morocco Tours</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 order-0 order-md-1">
                    <div class="about-thumb fade-anim" data-direction="right">
                        <img src="{{ asset('assets/img/desert-luxury-camp-morocco-sunset-traditional-tents.webp') }}"
                            ...
                            class="w-100" loading="lazy" width="800" height="600">
    ...
    <!--================= Travel-guides start =================-->
    <section class="travel-guides bg-second-theme-color position-relative space background-image"
        ...
        <img src="{{ asset('assets/img/icons/plain-sclation.png') }}" alt="Decorative paper airplane icon"
            class="travel-guides-icon-1 animate-parachute" loading="lazy" width="80" height="45">
        <img src="{{ asset('assets/img/icons/rops.png') }}" alt="Decorative climbing ropes icon"
            class="travel-guides-icon-2 animate-parachute" loading="lazy" width="70" height="70">
        <div class="container">
            <div class="row">
                <div class="col-lg-auto mx-auto">
                    <div class="title-area text-center">
    ...
    <section class="awards-style1 space" data-bg-src="{{ asset('assets/img/awards/awards-style1-bg.png') }}">
        <img class="awards-icon-1" src="{{ asset('assets/img/icons/award-icon-1.png') }}"
            alt="Decorative award ribbon icon" loading="lazy" width="70" height="115">
        <img class="awards-icon-2 move-item" src="{{ asset('assets/img/icons/award-icon-2.png') }}"
            alt="Decorative parachute icon" loading="lazy" width="55" height="85">
        <div class="container">
                ...
                <div class="col-md-6 col-lg-5 col-xxl-5">
                    <div class="google-reviewed overflow-hidden w-100" style="max-width: 450px;">
                        <div class="left bg-white-color d-flex align-items-center gap-2 p-2">
                            <img src="{{ asset('assets/img/icons/awards-google.png') }}" alt="Google logo for reviews"
                                style="max-width: 50px;" loading="lazy" width="50" height="50">
                            <div class="info">
                    ...
                    <div class="award-box-style1">
                        <div class="award-box-style1-wrapper">
                            <figure class="award-box-icon" aria-hidden="true">
                                <img src="{{ asset('assets/img/awards/ISO-Quality-Label.webp') }}"
                                    alt="ISO Quality Label" loading="lazy" width="132" height="103">
                            </figure>
                            <div
                                ...
                                <img src="{{ asset('assets/img/awards/award-box-left-wings.png') }}"
                                    alt="Decorative award wing graphic" loading="lazy" width="50" height="30">
    ...
    <div class="modal fade" id="guideModalHicham" tabindex="-1" aria-labelledby="guideModalLabelHicham"
        aria-hidden="true">
    ...
    <div class="modal fade" id="guideModalSalwa" tabindex="-1" aria-labelledby="guideModalLabelSalwa"
        aria-hidden="true">
        <div class="modal-dialog modal-lg modal-custom-width">
            <div class="modal-content">
    ...
    <div class="modal fade" id="guideModalHassan" tabindex="-1" aria-labelledby="guideModalLabelHassan"
        aria-hidden="true">
        <div class="modal-dialog modal-lg modal-custom-width">
            <div class="modal-content">
