...
<head>
    ...
    {{-- generate_lead: fires only after a real successful form submission
         ...
         from a button click). form_type/lead_source are set alongside
         'success' by each controller (TourInquiry/ActivityInquiry/Contact/
         Newsletter). No PII: only identifiers/slugs, never name/email/
         phone/message. --}}
