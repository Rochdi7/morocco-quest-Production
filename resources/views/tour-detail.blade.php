            ...
            <div class="row text-center">
                <div class="col-12">
                    <div class="breadcrumb-content">
                        <h1 class="breadcrumb-title">{{ $tour->title }}</h1>

                        @if ($tour->subtitle)
                            <p class="breadcrumb-subtitle" id="tourSubtitle" style="color: white; font-size: medium;">
                                {{ $tour->subtitle }}
                            </p>
                        @endif

                        {{-- Image Caption provides context but isn't a primary SEO factor like alt text --}}
                        <figcaption class="image-caption" style="color: white; font-size: medium; display: none;">
                            Experience an unforgettable camel ride through the golden sands of Merzouga, guided by local
                            Berbers under the magical Sahara sunset.
                        </figcaption>
                ...
                <div class="col-lg-8">
                    <div class="vs-destination-single">
                            ...
                            <div class="col-4 col-sm-2 d-flex justify-content-end">
                                @if ($tour->duration_days)
                                    <div class="destination-single-meta">
                                        ...
                                        <span>
                                            @if (is_numeric($tour->duration_days))
                                                {{ Str::plural('day', $tour->duration_days) }}
                                            @elseif (strpos($tour->duration_days, '/') !== false)
                                                Days
                                            @else
                                                {{ $tour->duration_days }}
                                            @endif
                        ...
                        <div class="destination-single-info">
                            <figure class="destination-single-img d-blockmb-4">
                                @php
                            ...
                            <div class="destination-single-px">
                                    ...
                                    <div class="destination-info-tabs">
                                        ...
                                        <ul class="custom-ul">
                                            ...
                                            @if ($tour->accommodations->count())
                                                {{-- Only show tab if accommodations exist
                                                --}}
                                ...
                                <div id="current" class="destination-overview tab-content">
                                    ...
                                    <div class="overview-text">
                                        @if ($tour->overview)
                                            {!! $tour->overview !!} {{-- Ensure this content is semantic, keyword-rich and
                                            well-formatted --}}
                                        @else
                                            <p>Details about the tour overview will be provided here. Contact us for more
                                                information about the {{ $tour->title }}.</p>
                                        @endif
                                    </div>
                                    <style>
                                        .overview-text {
                                    ...
                                    <ul class="custom-ul">
                                        ...
                                        <li>
                                            ...
                                            Visit the key attractions included in the {{ $tour->title }}.
                                        </li>
                                        <li>
                                            <i class="fa-solid fa-circle-arrow-right"></i>
                                ...
                                <div id="itinerary" class="destination-ltinerary tab-content">
                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapseItinDay{{ $day->id }}"
                                                            ...
                                                            <div class="accordion-body">
                                                                {{-- Use {!! !!} only if you trust the source of the description
                                                                HTML --}}
                                    ...
                                    @else
                                        <p class="mt-3">The detailed day-by-day itinerary is not available for this tour
                                            yet. Please contact us for more details about the {{ $tour->title }} schedule.
                                        </p>
                                    @endif
                                </div>
                                <script>
                                    document.addEventListener("DOMContentLoaded", function() {
                                        ...
                                        expandButtons.forEach(button => {
                                            ...
                                            button.addEventListener("click", function(e) {
                                                e.preventDefault();
                                                const section = button.closest(".tab-content");
                                                if (!section) return;

                                                const collapsibles = section.querySelectorAll(".accordion-collapse");
                                ...
                                <div id="cost" class="destination-cost tab-content">
                                    ...
                                    <div class="includes">
                                        ...
                                        @if (!empty($tour->includes) && is_string($tour->includes))
                                            ...
                                            @endif
                                        @else
                                            <p>Information about cost inclusions is currently unavailable for the
                                                {{ $tour->title }}.</p>
                                        @endif
                                    </div>
                                    <div class="excludes mt-4">
                                        ...
                                        @if (!empty($tour->excludes) && is_string($tour->excludes))
                                            ...
                                            @endif
                                        @else
                                            <p>Information about cost exclusions is currently unavailable for the
                                                {{ $tour->title }}.</p>
                                        @endif
                                    </div>
                                </div>
                                ...
                                @if ($tour->accommodations->count())
                                    <div id="accommodations" class="destination-accommodations tab-content">
                                        ...
                                        <div class="accordion-style2 accordion mt-3" id="accordionAccommodations">
                                            {{-- Added
                                            mt-3 --}}
                                                ...
                                                <div class="accordion-item">
                                                    ...
                                                    <h5 class="accordion-header"
                                                        ...
                                                        <button
                                                            ...
                                                            {{ $accommodation->city }}: {{ $accommodation->hotel_name }}
                                                        </button>
                                                    </h5>
                                                    <div id="collapseAccommodation{{ $index }}"
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            {{-- @if ($accommodation->rating) <p><strong>Rating:</strong> {{
                                                                $accommodation->rating }} Stars</p> @endif --}}
                                                        </div>
                                                    </div>
                                                </div>
                                            @endforeach
                                ...
                                <div id="review" class="destination-request tab-content"> {{-- ID is 'review' but content is
                                    ...
                                    <div class="row">
                                        <div class="col-12" id="contact"> {{-- Target for sidebar button --}}
                                            ...
                                            <form action="{{ route('tour.inquiry.submit', $tour) }}" method="post"
                                                class="form-style2">
                                                @csrf
                                                <div class="row">
                                                    {{-- Input fields preserved --}}
                                                    <div class="col-md-6 form-group">
                                                        <label for="inq_name">Your Name <span
                                                                class="text-danger">*</span></label>
                                                        <input id="inq_name" name="name" type="text"
                                                            class="form-control @error('name') is-invalid @enderror"
                                                            placeholder="Enter Your Name *" required
                                                            value="{{ old('name') }}" aria-label="Your Name"
                                                            aria-required="true" aria-describedby="nameError" />
                                                        @error('name')
                                                            <div id="nameError" class="invalid-feedback">{{ $message }}
                                                            </div>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <label for="inq_email">Your Email <span
                                                                class="text-danger">*</span></label>
                                                        <input id="inq_email" name="email" type="email"
                                                            class="form-control @error('email') is-invalid @enderror"
                                                            placeholder="Enter Your Email *" required
                                                            value="{{ old('email') }}" aria-label="Your Email Address"
                                                            aria-required="true" aria-describedby="emailError" />
                                                        @error('email')
                                                            <div id="emailError" class="invalid-feedback">{{ $message }}
                                                            </div>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <label for="inq_nationality">Nationality <span
                                                                class="text-danger">*</span></label>
                                                        <input id="inq_nationality" name="nationality" type="text"
                                                            class="form-control @error('nationality') is-invalid @enderror"
                                                            placeholder="Your Nationality *" required
                                                            value="{{ old('nationality') }}"
                                                            aria-label="Your Nationality" aria-required="true"
                                                            aria-describedby="nationalityError" />
                                                        @error('nationality')
                                                            <div id="nationalityError" class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <label for="inq_phone">Contact Number <span
                                                                class="text-danger">*</span></label>
                                                        <input id="inq_phone" name="phone" type="tel"
                                                            class="form-control @error('phone') is-invalid @enderror"
                                                            placeholder="Enter Your Number *" required
                                                            value="{{ old('phone') }}"
                                                            aria-label="Your Contact Phone Number" aria-required="true"
                                                            aria-describedby="phoneError" />
                                                        @error('phone')
                                                            <div id="phoneError" class="invalid-feedback">{{ $message }}
                                                            </div>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-6 form-group position-relative">
                                                        <label for="inq_arrival_date">Preferred Arrival Date <span
                                                                class="text-danger">*</span></label>
                                                        <input id="inq_arrival_date" name="arrival_date" type="text"
                                                            class="form-control @error('arrival_date') is-invalid @enderror"
                                                            placeholder="Departure Date *"
                                                            value="{{ old('arrival_date') }}" required
                                                            aria-label="Preferred Arrival Date" aria-required="true"
                                                            readonly />
                                                        @error('arrival_date')
                                                            <div id="arrivalDateError" class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        <label for="inq_duration_days">Preferred Duration (Days) <span
                                                                class="text-danger">*</span></label>
                                                        <input id="inq_duration_days" name="duration_days" type="number"
                                                            min="1"
                                                            class="form-control @error('duration_days') is-invalid @enderror"
                                                            placeholder="Number of Days *"
                                                            value="{{ old('duration_days', $tour->duration_days ?? ($tour->duration ? preg_replace('/[^0-9]/', '', $tour->duration) : 1)) }}"
                                                            required aria-label="Preferred Tour Duration in Days"
                                                            aria-required="true" aria-describedby="durationDaysError" />
                                                        @error('duration_days')
                                                            <div id="durationDaysError" class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <label for="inq_adults">No. of Adults <span
                                                                class="text-danger">*</span></label>
                                                        <input id="inq_adults" name="adults" type="number"
                                                            min="1"
                                                            class="form-control @error('adults') is-invalid @enderror"
                                                            placeholder="Number Of Adults *"
                                                            value="{{ old('adults', 1) }}" required
                                                            aria-label="Number of Adults" aria-required="true"
                                                            aria-describedby="adultsError" />
                                                        @error('adults')
                                                            <div id="adultsError" class="invalid-feedback">
                                                                {{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <label for="inq_children">No. of Children</label>
                                                        <input id="inq_children" name="children" type="number"
                                                            min="0"
                                                            class="form-control @error('children') is-invalid @enderror"
                                                            placeholder="Number Of Children"
                                                            value="{{ old('children', 0) }}"
                                                            aria-label="Number of Children"
                                                            aria-describedby="childrenError" />
                                                        @error('children')
                                                            <div id="childrenError" class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                        @enderror
                                                    </div>
                                                    <div class="col-12 form-group">
                                                        <label for="inq_message">Your Message / Specific Requests <span
                                                                class="text-danger">*</span></label>
                                                        <textarea id="inq_message" name="inquiry_message" rows="4"
                                                            class="form-control @error('inquiry_message') is-invalid @enderror"
                                                            placeholder="Enter Your Message or Specific Requests *" required aria-label="Your Message or Specific Requests"
                                                            aria-required="true" aria-describedby="messageError">{{ old('inquiry_message') }}</textarea>
                    ...
                    <aside class="sidebar-area tours-sidebar">
                        <div class="widget widget_trip-Availability accordion" id="accordionTripAvailability">
                            <div class="accordion-item">
                                ...
                                <div id="collapsePrice" class="accordion-collapse collapse show"
                                    aria-labelledby="headingPrice" data-bs-parent="#accordionTripAvailability">
                                    <div class="accordion-body">
                                        <div class="header">
                                        ...
                                        <div class="body">
                                            ...
                                            <ul class="custom-ul">
                                                ...
                                                <li><i class="fa-solid fa-badge-check"></i> Professional Local Guide
                                                    Included</li>
                                            </ul>
                                        </div>
                                        <style>
                                        ...
                                        <div class="footer">
                                            ...
                                            {{-- Existing Button --}}
                                            <a href="#contact" class="vs-btn style9 w-100">
                                                Send Inquiry
                                            </a>

                                            {{-- New WhatsApp Button --}}
                                            <a href="https://wa.me/212654069718?text=Hello%2C%20I%20would%20like%20to%20check%20availability%20and%20book%20this%20tour%20via%20your%20website."
                                                target="_blank" class="vs-btn style9 whatsapp-btn w-100 mt-2"
                        ...
                        <div class="widget widget_trip">
                            ...
                            @if ($tour->departure)
                                <div class="trip-info-box">
                                    <div class="header">
                                        {{-- SVG preserved --}} <svg xmlns="http://www.w3.org/2000/svg" width="18"
                            ...
                            @if ($tour->best_season)
                                <div class="trip-info-box">
                                    <div class="header">
                                        {{-- SVG preserved --}} <svg xmlns="http://www.w3.org/2000/svg" width="19"
                                            height="20" viewBox="0 0 19 20" fill="none">
                                            <path d="M6.96484 0H8.08164V1.58782H6.96484V0Z" fill="currentColor" />
                                            <path
                                            ...
                                            <path
                                                ...
                                                fill="currentColor" />
                                            <path d="M0.277344 6.68616H1.8652V7.80295H0.277344V6.68616Z"
                                                fill="currentColor" />
                                            <path
                ...
                <div class="row g-4">
                    @foreach ($relatedTours as $relatedTour)
                        <div class="col-md-6 col-xl-4">
                            <div class="tour-package-box style-3 bg-white-color h-100 d-flex flex-column">
                                {{-- Added flex for
                                footer push --}}
                                <div class="tour-package-thumb">
                                    @php
                                        $relatedTourImageObject =
                                    ...
                                    <a href="{{ route('tours.show', $relatedTour->slug ?? $relatedTour->id) }}">
                                        ...
                                        <img src="{{ $relatedTourImageUrl }}" alt="{{ $relatedTourAlt }}"
                                            {{-- Specific Alt Text
                                            --}} class="w-100" loading="lazy" {{-- Added lazy loading for below-the-fold images --}}
                                ...
                                <div class="tour-package-content flex-grow-1 d-flex flex-column"> {{-- Added flex grow --}}
                                    @isset($relatedTour->departure)
                                        <div class="location mb-2"><i
                                                class="fa-sharp fa-light fa-location-dot me-1"></i><span>{{ $relatedTour->departure }}</span>
                                        </div>
                                    @endisset
                                    {{-- H5 for card title is appropriate --}}
                                    <h5 class="title line-clamp-2 mb-3 flex-grow-1"> {{-- Added flex grow to title wrapper/container
                                        if needed --}}
                                        <a
                                            href="{{ route('tours.show', $relatedTour->slug ?? $relatedTour->id) }}">{{ $relatedTour->title }}</a>
                                    </h5>
                                    <div
                                        class="tour-package-footer d-flex justify-content-between align-items-center mt-auto">
                                        {{--
                                        Added mt-auto to push footer down --}}
                                        @if ($relatedTour->duration_days)
                                            <div class="tour-duration"><i class="fa-regular fa-clock me-1"></i>
                                                <span>{{ $relatedTour->duration_days }}
                                                    {{ Str::plural('Day', $relatedTour->duration_days) }}</span>
                                            </div>
