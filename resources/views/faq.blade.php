...
@section('content')
                ...
                <div class="col-12">
                    <div class="breadcrumb-content">
                        ...
                        <p class="visually-hidden">
                            A knowledgeable Moroccan guide engages travelers with cultural insights during a guided tour of
                            Dar El Bacha in Marrakech. Known for its stunning architecture and rich history, Dar El Bacha is
                            a must-visit landmark for those exploring Morocco’s imperial heritage.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="vs-faq space" data-bg-src="{{ asset('assets/img/bg/404-faq.png') }}"> {{-- Ensure background image is optimized --}}
        <div class="container">
            <div class="row">
                <div class="col-lg-auto mx-auto">
                    <div class="title-area text-center">
                        <span class="sec-subtitle text-capitalize fade-anim" data-direction="top">Help Center</span>
                        {{-- H2: Section heading --}}
                        <h2 class="sec-title fade-anim" data-direction="bottom">
                            Answers to Common Morocco Travel Questions
                        </h2>
                    </div>
                </div>
            </div>
            <div class="row g-3">
                ...
                <div class="col-lg-6">
                    <div class="accordion accordion-style1" id="accordionLeft">
                        ...
                        <div class="accordion-item">
                            <h6 class="accordion-header" id="headingOneV1">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapseOneV1" aria-expanded="true" aria-controls="collapseOneV1">
                                    What travel documents do I need for Morocco?
                                </button>
                            </h6>
                            <div id="collapseOneV1" class="accordion-collapse collapse show" aria-labelledby="headingOneV1"
                                data-bs-parent="#accordionLeft">
                                <div class="accordion-body">
                                    <p>Most travelers need a passport valid for at least six months from their entry date.
                                        Visa requirements depend on your nationality. We recommend checking with the
                                        official Moroccan consulate or embassy website for your country well before your
                                        trip.</p>
                        ...
                        {{-- === FAQ Item 2 === --}}
                        <div class="accordion-item">
                            <h6 class="accordion-header" id="headingTwoV1">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapseTwoV1" aria-expanded="false" aria-controls="collapseTwoV1">
                                    Is Morocco safe for tourists, especially solo female travelers?
                                </button>
                            </h6>
                            <div id="collapseTwoV1" class="accordion-collapse collapse" aria-labelledby="headingTwoV1"
                                data-bs-parent="#accordionLeft">
                                <div class="accordion-body">
                                    <p>Morocco is generally considered safe for tourists, including solo female travelers.
                                        Standard precautions apply, like being aware of surroundings, especially in busy
                                        markets (souks). Traveling with a reputable guide or group like Morocco Quest can
                                        enhance safety and local insights. Dressing modestly is often appreciated in more
                                        traditional areas.</p>
                                    <p>If you have further questions, please <a href="/contact"
                                            style="color: #bb5e2a;">contact us</a>.</p>
                                </div>
                        ...
                        {{-- === FAQ Item 3 === --}}
                        <div class="accordion-item">
                            <h6 class="accordion-header" id="headingThreeV1">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapseThreeV1" aria-expanded="false" aria-controls="collapseThreeV1">
                                    What's the best time of year to visit Morocco?
                                </button>
                            </h6>
                            <div id="collapseThreeV1" class="accordion-collapse collapse" aria-labelledby="headingThreeV1"
                                data-bs-parent="#accordionLeft">
                                <div class="accordion-body">
                                    <p>Spring (March-May) and Autumn (September-November) offer the most pleasant weather
                                        across the country. Summers can be very hot, particularly in the desert and
                                        Marrakech. Winters are mild on the coast but can be cold with snow in the Atlas
                                        Mountains.</p>
                                    <p>If you have further questions, please <a href="/contact"
                                            style="color: #bb5e2a;">contact us</a>.</p>
                                </div>
                        ...
                        {{-- === FAQ Item 4 === --}}
                        <div class="accordion-item">
                            <h6 class="accordion-header" id="headingFourV1">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapseFourV1" aria-expanded="false" aria-controls="collapseFourV1">
                                    What currency should I use and how accessible are ATMs?
                                </button>
                            </h6>
                            <div id="collapseFourV1" class="accordion-collapse collapse" aria-labelledby="headingFourV1"
                                data-bs-parent="#accordionLeft">
                                <div class="accordion-body">
                                    <p>The currency is the Moroccan Dirham (MAD). While credit cards are common in hotels
                                        and larger shops/restaurants in cities, cash is essential for smaller purchases,
                                        taxis, and souks. ATMs are readily available in cities and larger towns.</p>
                                    <p>If you have further questions, please <a href="/contact"
                                            style="color: #bb5e2a;">contact us</a>.</p>
                                </div>
                            </div>
                ...
                {{-- Right Column of FAQs --}}
                <div class="col-lg-6">
                    <div class="accordion accordion-style1" id="accordionRight">

                        {{-- === FAQ Item 5 === --}}
                        <div class="accordion-item">
                            <h6 class="accordion-header" id="headingOneV2">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapseOneV2" aria-expanded="false" aria-controls="collapseOneV2">
                                    How do I book a tour with Morocco Quest?
                                </button>
                            </h6>
                            <div id="collapseOneV2" class="accordion-collapse collapse" aria-labelledby="headingOneV2"
                                data-bs-parent="#accordionRight">
                                <div class="accordion-body">
                                    <p class="justify-text">
                                        Booking a tour with Morocco Quest is simple and easy. You can visit our website,
                                        browse through our
                                        exciting tours, and click the "Book Now" button. Fill in the necessary details, and
                                        our team will
                                        contact you shortly to confirm your reservation. You can also call us directly for
                                        any special
                                        requests or personalized itineraries.
                                    </p>
                                    <p>If you have further questions, please <a href="/contact"
                                            style="color: #bb5e2a;">contact us</a>.</p>
                                </div>
                        ...
                        {{-- === FAQ Item 6 === --}}
                        <div class="accordion-item">
                            <h6 class="accordion-header" id="headingTwoV2">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapseTwoV2" aria-expanded="false" aria-controls="collapseTwoV2">
                                    What is typically included in your tour price?
                                </button>
                            </h6>
                            <div id="collapseTwoV2" class="accordion-collapse collapse" aria-labelledby="headingTwoV2"
                                data-bs-parent="#accordionRight">
                                <div class="accordion-body">
                                    <p>Specific inclusions are listed on each tour page. Generally, multi-day tours include
                                        accommodation, transportation within Morocco, specified meals (e.g., breakfast
                                        daily, some dinners), guided sightseeing, and entrance fees mentioned in the
                                        itinerary. Flights to/from Morocco are usually not included.</p>
                                    <p>If you have further questions, please <a href="/contact"
                                            style="color: #bb5e2a;">contact us</a>.</p>
                                </div>
                            </div>
                        ...
                        {{-- === FAQ Item 7 === --}}
                        <div class="accordion-item">
                            <h6 class="accordion-header" id="headingThreeV2">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapseThreeV2" aria-expanded="false"
                                    aria-controls="collapseThreeV2">
                                    Can you cater to dietary restrictions (vegetarian, gluten-free)?
                                </button>
                            </h6>
                            <div id="collapseThreeV2" class="accordion-collapse collapse"
                                aria-labelledby="headingThreeV2" data-bs-parent="#accordionRight">
                                <div class="accordion-body">
                                    <p>Yes, we can usually accommodate common dietary needs like vegetarian, vegan, or
                                        gluten-free. Please inform us clearly at the time of booking so we can make
                                        necessary arrangements with our accommodation and meal partners.</p>
                                    <p>If you have further questions, please <a href="/contact"
                                            style="color: #bb5e2a;">contact us</a>.</p>
                                </div>
                            </div>
                        ...
                        {{-- === FAQ Item 8 === --}}
                        <div class="accordion-item">
                            <h6 class="accordion-header" id="headingFourV2">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <div id="collapseFourV2" class="accordion-collapse collapse" aria-labelledby="headingFourV2"
                                data-bs-parent="#accordionRight">
                                <div class="accordion-body">
                                    <p>Packing depends on the season and regions visited. Generally, bring layers (light
                                        clothing for day, warmer layers for evenings/mountains/desert nights), comfortable
                                        walking shoes, sun protection (hat, sunglasses, sunscreen), modest clothing options
                                        for visiting religious sites, and any personal medications. We provide a suggested
                                        packing list upon booking.</p>
                                    <p>If you have further questions, please <a href="/contact"
                                            style="color: #bb5e2a;">contact us</a>.</p>
                                </div>
                            </div>
            ...
            {{-- Counter Section - Kept structure, ensure counts are accurate --}}
            <div class="row space-top">
                <div class="col-12">
                    <div class="counter-style1" data-bg-src="{{ asset('assets/img/bg/counter-style1-bg.png') }}"
                        {{-- Ensure background image is optimized --}}>
                        <div class="counter-thumb">
                            {{-- Counter Image: Added loading="lazy", improved alt text --}}
                            <img src="{{ asset('assets/img/morocco-desert-4x4-adventure-tour-rural-landscape.webp') }}"
                                alt="Group of happy tourists on a Morocco Quest tour enjoying the scenery"
                                {{-- Improved alt text --}} class="w-100" loading="lazy" {{-- Added Lazy Loading --}}
                                {{-- width="X" height="Y" --}} {{-- Recommended: Add dimensions --}} />
                        </div>
                        <div class="counter-states">
                            {{-- !! IMPORTANT: Update data-count values to reflect real numbers !! --}}
                            <div class="counter-box">
                                <svg xmlns="http://www.w3.org/2000/svg" width="56" height="54"
                                    viewBox="0 0 56 54" fill="none" aria-hidden="true">
                                    <path
                            ...
                            <div class="counter-box">
                                <svg xmlns="http://www.w3.org/2000/svg" width="49" height="50"
                                    viewBox="0 0 49 50" fill="none" aria-hidden="true">
                                    <path
                            ...
                            <div class="counter-box">
                                <svg xmlns="http://www.w3.org/2000/svg" width="55" height="54"
                                    viewBox="0 0 55 54" fill="none" aria-hidden="true">
                                    <path
                            ...
                            <div class="counter-box">
                                <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56"
                                    viewBox="0 0 56 56" fill="none" aria-hidden="true">
                                    <path
    ...
    {{-- Odometer JS & Initialization Script - Kept structure, refined JS --}}
    {{-- Consider loading this JS only when needed or bundling it --}}
    @push('scripts')
        <script src="https://cdnjs.cloudflare.com/ajax/libs/odometer.js/0.4.8/odometer.min.js"></script>
        <script>
            function animateOdometers() {
                // Find all odometer elements that haven't been counted yet
                const odometersToAnimate = document.querySelectorAll(".odometer:not(.counted)");

                odometersToAnimate.forEach(el => {
                    ...
                    if (inView) {
                        ...
                        // Use setTimeout to ensure the class is applied before Odometer updates
                        setTimeout(() => {
            ...
            document.addEventListener("DOMContentLoaded", animateOdometers);

            // Check on scroll, using passive listener for performance
