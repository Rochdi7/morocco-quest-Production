...
<?php $__env->startSection('content'); ?>
    <main class="main">
        ...
        <section class="z-index-common hero-layout1 overflow-clip"
            data-bg-src="<?php echo e(asset('assets/img/ait-benhaddou-morocco-travel-hero-banner.webp')); ?>">
            ...
            <div style="max-width: 1200px; margin: 0 auto;" class="search-box fade-anim" data-delay="0.77"
                data-direction="top">
                <form action="<?php echo e(route('search.bar')); ?>" method="GET" class="align-items-center">
                    <div class="form-group ps-0 position-relative">
                        ...
                        <select id="select-division" name="place" class="form-select custom-select pe-5" required>
                            <option value="" disabled <?php echo e(!request('place') ? 'selected' : ''); ?> hidden>
                                Select Division
                            </option>
                            <?php if(isset($locations)): ?>
                                <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locationName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($locationName); ?>"
                                        <?php echo e(request('place') == $locationName ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group position-relative">
                        ...
                        <input type="text" id="search-date" name="searchDate" class="form-select custom-select pe-5"
                            placeholder="Date from" value="<?php echo e(request('searchDate')); ?>" readonly>
                    ...
                    <div class="form-group position-relative">
                        ...
                        <select id="guest-dropdown" name="guests" class="form-select custom-select pe-5" required>
                            <option value="" disabled <?php echo e(!request('guests') ? 'selected' : ''); ?> hidden>
                                Select Guests
                            </option>
                            <?php for($i = 1; $i <= 12; $i++): ?>
        ...
        <?php if(isset($topTours) && $topTours->count() > 0): ?>
                        ...
                        <div class="col-12 mt-30 mt-md-0 fade-anim" data-direction="right">
                            <div class="swiper tour-package-slider">
                                <div class="swiper-wrapper">
                                    <?php $__currentLoopData = $topTours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="swiper-slide">
                                            <div class="tour-package-box bg-white-color">
                                                <div class="tour-package-thumb">
                                                    ...
                                                    <?php if($tourImageUrl): ?>
                                                        <img src="<?php echo e($tourImageUrl); ?>" alt="<?php echo e($tour->title); ?>"
                                                ...
                                                <div class="tour-package-content">
                                                    <h5 class="title line-clamp-2">
                                                        <a
                                                            href="<?php echo e(route('tours.show', ['slug' => $tour->slug])); ?>"><?php echo e($tour->title); ?></a>
                                                    </h5>
                                                    ...
                                                    <div class="pricing-container">
                                                        <div class="package-info">
                                                            <span class="package-location">
                                                                ...
                                                                <?php echo e($tour->location ?? ($tour->departure ?? 'Various Locations')); ?>
                                                        ...
                                                        <div class="price-info">
                                                            <?php if(!empty($tour->discount) && $tour->discount > 0): ?>
                                                                <span class="price-off text-white-color ff-poppins">
                                                                    <?php echo e($tour->discount); ?>% OFF
                                                                </span>
                                                            <?php endif; ?>
                                                            <div class="price">
                                                    ...
                                                    <a href="<?php echo e(route('tours.show', ['slug' => $tour->slug])); ?>"
                            ...
                            <?php if(Route::has('tours.index')): ?>
                                <div class="text-center mt-50">
                                    <a href="<?php echo e(route('destinations.index')); ?>" class="vs-btn style4">
        ...
        <section class="vs-destination-style1 bg-third-theme-12 overflow-hidden space"
            data-bg-src="<?php echo e(asset('assets/img/bg/destination.png')); ?>">
            <img class="des-icon-1 animate-parachute" src="<?php echo e(asset('assets/img/icons/destination-icon-1.png')); ?>"
                alt="Hot air balloon icon" loading="lazy">
            <img class="des-icon-2 animate-tree" src="<?php echo e(asset('assets/img/icons/destination-icon-2.png')); ?>"
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <?php if(isset($featuredActivities)): ?>
                            <?php if($featuredActivities->count() > 0): ?>
                                <div class="destination-box-wrapper">
                                    <?php $__currentLoopData = $featuredActivities->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        ?>
                                        <a href="<?php echo e(route('activities.show', $activity->slug)); ?>"
                                            class="destination-box d-block text-decoration-none <?php if($loop->first): ?> active <?php endif; ?>">
                                            <div class="destination-thumb">
                                                <?php if($activity->is_popular): ?>
                                                    <span class="badge-activity-popular">Popular</span>
                                                <?php endif; ?>
                                                <img src="<?php echo e($activityImageUrl); ?>"
                                                    alt="<?php echo e($activity->title ?? 'Private Morocco Tour Experience'); ?>"
                                            ...
                                            <div class="destination-content">
                                                <div class="info">
                                                    <h5 class="text-white text-capitalize mb-1"
                                                        ...
                                                        <?php echo e($activity->title ?? 'Private Morocco Tour'); ?>
                                                    ...
                                                    <?php
                                                        $subtitle =
                                                            ...
                                                            (Str::limit($activity->short_description, 30) ??
                                                                'Exclusive Travel Experiences');
                                                    ?>
                                                    <span class="text-theme-color d-block"><?php echo e($subtitle); ?></span>
                                                </div>
                                                <span class="icon bg-theme-color text-white-color"
                                                    aria-label="View <?php echo e($activity->title ?? 'Activity'); ?>">
                                ...
                                <?php if(Route::has('activities.index')): ?>
                                    <div class="text-center mt-50 btn-trigger btn-bounce">
                                        <a href="<?php echo e(route('activity-categories.index')); ?>" class="vs-btn style4">
            ...
            <div class="row destination-gallery g-0">
                <div class="col-lg-6 p-0">
                    <figure class="destination-gallery-box h-100">
                        <img src="<?php echo e(asset('assets/img/agafay-desert-luxury-camp-camel-trek-morocco.webp')); ?>"
                            srcset="<?php echo e(asset('assets/img/agafay-desert-luxury-camp-camel-trek-morocco-480.webp')); ?> 480w,
                            <?php echo e(asset('assets/img/agafay-desert-luxury-camp-camel-trek-morocco.webp')); ?> 960w"
                        ...
                        <div class="icon-box">
                            <a href="<?php echo e(asset('assets/img/agafay-desert-luxury-camp-camel-trek-morocco.webp')); ?>"
                    ...
                    <div class="row g-0">
                        <div class="col-sm-6 p-0">
                            <div class="destination-gallery-box h-100">
                                <img src="<?php echo e(asset('assets/img/moroccan_traditional_mechoui_evening_firepit.webp')); ?>"
                                ...
                                <div class="icon-box">
                                    <a href="<?php echo e(asset('assets/img/moroccan_traditional_mechoui_evening_firepit.webp')); ?>"
                        ...
                        <div class="col-sm-6 p-0">
                            <div class="destination-gallery-box h-100">
                                <img src="<?php echo e(asset('assets/img/moroccan_pastries_hospitality_serving.webp')); ?>"
                                    alt="vip morocco tours" title="exclusive experiences"
                                    class="w-100 h-100 object-fit-cover" loading="lazy" width="600" height="540">

                                <div class="icon-box">
                                    <a href="<?php echo e(asset('assets/img/moroccan_pastries_hospitality_serving.webp')); ?>"
                        ...
                        <div class="col-sm-6 p-0">
                            <div class="destination-gallery-box h-100">
                                <img src="<?php echo e(asset('assets/img/gnawa_musician_morocco_local_encounter.webp')); ?>"
                                    alt="private tour morocco" title="authentic moroccan music"
                                    class="w-100 h-100 object-fit-cover" loading="lazy" width="600" height="540">

                                <div class="icon-box">
                                    <a href="<?php echo e(asset('assets/img/gnawa_musician_morocco_local_encounter.webp')); ?>"
                        ...
                        <div class="col-sm-6 p-0">
                            <div class="destination-gallery-box h-100">
                                <img src="<?php echo e(asset('assets/img/souk_experience_morocco_cultural_discoveries.webp')); ?>"
                                    alt="morocco travel agent guided souk" title="moroccan cultural markets"
                                    class="w-100 h-100 object-fit-cover" loading="lazy" width="600" height="540">

                                <div class="icon-box">
                                    <a href="<?php echo e(asset('assets/img/souk_experience_morocco_cultural_discoveries.webp')); ?>"
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    ...
                    <div
                        ...
                        <a class="vs-btn style-4 bg-second-theme-color" href="<?php echo e(route('contact.show')); ?>#plan">
        ...
        <div class="vs-services-style1 space bg-second-theme-color">
            <img src="<?php echo e(asset('assets/img/icons/cloud.png')); ?>" alt="Decorative cloud icon"
                class="vs-services-style1-icon-1 animate-parachute" width="97" height="47">
            <img src="<?php echo e(asset('assets/img/icons/ballon.png')); ?>" alt="Decorative hot air balloon icon"
                    ...
                    <div class="col-md-6 text-center text-md-start">
                        <div class="row">
                            <div class="col-12 col-xl-11">
                                ...
                                <a class="vs-btn style-4 fade-anim" data-direction="top"
                                    href="<?php echo e(route('destinations.index')); ?>">View All Services</a>
                            </div>
                        </div>
                        ...
                        <div class="row g-4 pt-120">
                                ...
                                <a href="#support-popup" class="popup-inline text-decoration-none"
                                    ...
                                    <div class="vs-services-box-style1">
                                        <figure class="services-thumb">
                                            <img src="<?php echo e(asset('assets/img/morocco-desert-adventure-support.webp')); ?>"
                            ...
                            <div class="col-lg-6 fade-anim">
                                <div class="vs-services-box-style1">
                                    <figure class="services-thumb">
                                        <img src="<?php echo e(asset('assets/img/morocco-train-station-al-boraq-travel.webp')); ?>"
                    ...
                    <div class="col-md-6">
                        <div class="row g-4">
                            <div class="col-lg-6 fade-anim">
                                <div class="vs-services-box-style1">
                                    <figure class="services-thumb">
                                        <img src="<?php echo e(asset('assets/img/morocco-sahara-desert-view-camels.webp')); ?>"
                            ...
                            <div class="col-lg-6 fade-anim">
                                <div class="vs-services-box-style1">
                                    <figure class="services-thumb">
                                        <img src="<?php echo e(asset('assets/img/morocco-ocean-view-travel-guide.webp')); ?>"
                            ...
                            <div class="col-12 fade-anim">
                                <div class="vs-services-box-style1 v2">
                                    ...
                                    <div class="services-content d-flex align-items-center gap-3">
                                        <img src="<?php echo e(asset('assets/img/services/vs-services-box-style1-v2-avatars.png')); ?>"
                                            alt="Happy traveler avatars" loading="lazy" width="168" height="40">
                                        
                                    </div>
                                    <img src="<?php echo e(asset('assets/img/icons/eiffel-tower.png')); ?>"
        ...
        <!--================= Services Area end =================-->
        <!--================= Awards Area start =================-->
        <section class="awards-style1 space" data-bg-src="<?php echo e(asset('assets/img/awards/awards-style1-bg.png')); ?>">
            <img class="awards-icon-1" src="<?php echo e(asset('assets/img/icons/award-icon-1.png')); ?>"
                alt="Decorative award laurel icon" width="70" height="115">
            <img class="awards-icon-2 move-item" src="<?php echo e(asset('assets/img/icons/award-icon-2.png')); ?>"
                    ...
                    <div class="col-md-6 col-lg-5 col-xxl-5">
                        <div class="google-reviewed overflow-hidden w-100" style="max-width: 450px;">
                            <div class="left bg-white-color d-flex align-items-center gap-2 p-2">
                                <img src="<?php echo e(asset('assets/img/icons/awards-google.png')); ?>" alt="Google logo"
                        ...
                        <div class="award-box-style1">
                            <div class="award-box-style1-wrapper">
                                ...
                                <div
                                    ...
                                    <img src="<?php echo e(asset('assets/img/awards/award-box-left-wings.png')); ?>"
                                        alt="Decorative award wings" width="50" height="30">
                                    <h6 class="text-capitalize ff-rubik fw-semibold">
                                        TripAdvisor Travellers' Choice
                                    </h6>

                                    <img src="<?php echo e(asset('assets/img/awards/award-box-right-wings.png')); ?>"
                                        alt="Decorative award wings" width="50" height="30">
                                </div>
                            ...
                            <div class="vs-blog-box style1">
                                <figure class="blog-thumb">
                                    <a href="<?php echo e(route('blog.show', $post->slug)); ?>">
                                        <img src="<?php echo e($post->featured_image_url); ?>" loading="lazy"
                                            alt="<?php echo e($post->title); ?>" class="w-100" width="410" height="275">
                                    </a>
                                </figure>
                                ...
                                <div class="blog-content">
                                        ...
                                        <ul class="custom-ul">
                                            <li>
                                                <a href="#"><i class="fa fa-user-circle"></i> by
                                                    <?php echo e($post->written_by); ?></a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(route('blog.show', $post->slug)); ?>#comments">
                                            ...
                                            <li class="date">
                                                <div class="vs-blog-date">
                                                    <span class="date-number"><?php echo e($post->created_day); ?></span>
                                                    <span class="date-month"><?php echo e($post->created_month); ?></span>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="blog-footer">
                                        <a href="<?php echo e(route('blog.show', $post->slug)); ?>" class="vs-btn style4">
                                        ...
                                        <ul class="custom-ul blog-share">
                                            <li>
                                                ...
                                                <ul class="custom-ul share-list">
                                                    ...
                                                    <li>
                                                        <a href="https://pinterest.com/pin/create/button/?url=<?php echo e(urlencode(route('blog.show', $post->slug))); ?>&media=<?php echo e(urlencode($post->featured_image_url)); ?>&description=<?php echo e(urlencode($post->title)); ?>"
                                                    ...
                                                    <li>
                                                        <a href="https://www.instagram.com/?url=<?php echo e(urlencode(route('blog.show', $post->slug))); ?>"
                                                    ...
                                                    <li>
                                                        <a href="https://www.tiktok.com/upload?url=<?php echo e(urlencode(route('blog.show', $post->slug))); ?>"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="swiper partner-slider space-top custom-swiper"
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="<?php echo e(asset('assets/img/partner/paypal.webp')); ?>" alt="PayPal"
                                        class="mono-logo" loading="lazy" width="200" height="50">
                                </div>
                                <div class="swiper-slide">
                                    <img src="<?php echo e(asset('assets/img/partner/nationalgeographic.webp')); ?>"
                                        alt="National Geographic" class="mono-logo" loading="lazy" width="200"
                                        height="50">
                                </div>
                                <div class="swiper-slide">
                                    <img src="<?php echo e(asset('assets/img/partner/visitemorocco.webp')); ?>" alt="Visit Morocco"
                                        class="mono-logo" loading="lazy" width="200" height="50">
                                </div>
                                <div class="swiper-slide">
                                    <img src="<?php echo e(asset('assets/img/partner/condenast.webp')); ?>" alt="Condé Nast"
                                        class="mono-logo" loading="lazy" width="200" height="50">
                                </div>
                                <div class="swiper-slide">
                                    <img src="<?php echo e(asset('assets/img/partner/onmt.webp')); ?>" alt="ONMT"
                                        class="mono-logo" loading="lazy" width="200" height="50">
                                </div>
                            </div>
                        </div>
    ...
    <div id="travel-guide-popup" class="mfp-hide service-popup">
        <div class="popup-inner">
            <div class="popup-image">
                <img src="<?php echo e(asset('assets/img/morocco-ocean-view-travel-guide.webp')); ?>" alt="Expert Travel Guide">
            </div>
            <div class="popup-content">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Projects\public_html\resources\views/home.blade.php ENDPATH**/ ?>