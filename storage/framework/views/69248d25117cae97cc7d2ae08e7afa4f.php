    ...
    <div class="vs-menu-area text-center">
        <div class="mobile-logo">
            <a href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(asset('assets/img/logo-bg-wide-white.webp')); ?>" alt="Morocco Quest" class="logo"
                    width="240" height="77">
            </a>
        ...
        <div class="vs-mobile-menu">
            <ul>
                <li class="menu-item-has-children">
                    <a href="<?php echo e(route('tours.multi_day')); ?>">Multi-Day Tours</a>
                    <ul class="sub-menu">
                        <li><a href="<?php echo e(route('tours.type', 'Garden Tours')); ?>">Garden Tours</a></li>
                        <li><a href="<?php echo e(route('tours.type', 'Art Tours')); ?>">Art Tours</a></li>
                        <li><a href="<?php echo e(route('tours.type', 'Classical Tours')); ?>">Classical Tours</a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children">
                    <a href="<?php echo e(route('activity-categories.index')); ?>">One-Day Tours</a>
                    <ul class="sub-menu">
                        <li><a href="<?php echo e(route('activities.byCategory', 'city-tours')); ?>">City Tours</a></li>
                        <li><a href="<?php echo e(route('activities.byCategory', 'day-trips')); ?>">Day Trips</a></li>
                        <li><a href="<?php echo e(route('activities.byCategory', 'local-experiences')); ?>">Local Experiences</a>
                        </li>
                        <li><a href="<?php echo e(route('activities.byCategory', 'outdoor-activities')); ?>">Outdoor Activities</a>
                        </li>
                        <li><a href="<?php echo e(route('activities.byCategory', 'wellness-experiences')); ?>">Wellness</a></li>
                        <li><a href="<?php echo e(route('activities.byCategory', 'food-culinary-tours')); ?>">Food & Culinary
                                Tours</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                <li><a href="<?php echo e(route('activities.byCategory', 'city-tours')); ?>">City Tours</a></li>
                                <li><a href="<?php echo e(route('activities.byCategory', 'day-trips')); ?>">Day Trips</a></li>
                                <li><a href="<?php echo e(route('activities.byCategory', 'local-experiences')); ?>">Local
                                        Experiences</a></li>
                                <li><a href="<?php echo e(route('activities.byCategory', 'outdoor-activities')); ?>">Outdoor
                                        Activities</a></li>
                                <li><a
                                        href="<?php echo e(route('activities.byCategory', 'wellness-experiences')); ?>">Wellness</a>
                                </li>
                                <li><a href="<?php echo e(route('activities.byCategory', 'food-culinary-tours')); ?>">Food &
                                        Culinary Tours</a></li>
                            </ul>
                        </li>
                        ...
                        <li><a href="<?php echo e(route('contact.show')); ?>">Contact</a></li>
                    </ul>
                </nav>
                <div class="logo d-lg-none">
                    <a href="<?php echo e(url('/')); ?>">
                        <img src="<?php echo e(asset('assets/img/logo-bg-wide-white.webp')); ?>" alt="Morocco Quest"
            ...
            <div class="col-xl-3 col-md-auto col-auto">
                <div class="header-wc style2">
                    ...
                    <div class="logo d-none d-sm-block">
                        <a href="<?php echo e(route('contact.show')); ?>#plan" class="vs-btn style8">
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-xl-3 col-lg-auto">
                    <div class="header-logo d-flex justify-content-between align-items-center">
                        <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('assets/img/logo-bg-wide.webp')); ?>"
                ...
                <div class="col-xl-9 col-lg-auto d-none d-lg-flex justify-content-end gap-md-4 gap-xl-5">
                        ...
                        <ul class="d-flex justify-content-center align-items-center">
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    <li><a href="<?php echo e(route('tours.type', 'Garden Tours')); ?>">Garden Tours</a></li>
                                    <li><a href="<?php echo e(route('tours.type', 'Art Tours')); ?>">Art Tours</a></li>
                                    <li><a href="<?php echo e(route('tours.type', 'Classical Tours')); ?>">Classical Tours</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children">
                                <a href="<?php echo e(route('activity-categories.index')); ?>">One-Day Tours</a>
                                <ul class="sub-menu">
                                    <li><a href="<?php echo e(route('activities.byCategory', 'city-tours')); ?>">City Tours</a>
                                    </li>
                                    <li><a href="<?php echo e(route('activities.byCategory', 'day-trips')); ?>">Day Trips</a></li>
                                    <li><a href="<?php echo e(route('activities.byCategory', 'local-experiences')); ?>">Local
                                            Experiences</a></li>
                    ...
                    <div class="header-wc style2">
                        ...
                        <a href="<?php echo e(url('/contact')); ?>#plan" class="vs-btn style8">
                            <span>let’s plan</span>
                        </a>
                    </div>
                </div>
...
<?php /**PATH C:\Users\ASUS\Desktop\Projects\public_html\resources\views/partials/header.blade.php ENDPATH**/ ?>