...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('assets/img/favicons/apple-touch-icon.png')); ?>">
    ...
    <link rel="alternate" type="application/manifest+json" href="<?php echo e(asset('assets/img/favicons/manifest.json')); ?>">
    ...
    <link rel="preload" as="image" href="<?php echo e(asset('assets/img/ait-benhaddou-morocco-travel-hero-banner.webp')); ?>"
        fetchpriority="high" />
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/animate.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/jquery-ui.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/magnific-popup.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/odometer.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/swiper-bundle.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/daterangepicker.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/new_style.css')); ?>">
...
<body class="vs-body">
    <div class="preloader">
        ...
        <div class="preloader-inner">
            <img src="<?php echo e(asset('assets/img/logo-white.bg.webp')); ?>" alt="Morocco Quest Logo Preloader"
...
<?php /**PATH C:\Users\ASUS\Desktop\Projects\public_html\resources\views/layouts/app.blade.php ENDPATH**/ ?>