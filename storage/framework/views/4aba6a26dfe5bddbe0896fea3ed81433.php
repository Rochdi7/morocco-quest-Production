...
<!-- ================= Footer Start ================= -->
<footer class="vs-footer-style1" data-bg-src="<?php echo e(asset('assets/img/footer/footer-style1-bg.png')); ?>">
    <div class="footer-top space-top">
        <div class="container">
            <div class="row gx-4">
                <div class="col-12">
                    <div class="footer-cta bg-third-theme-color fade-anim"
                        data-bg-src="<?php echo e(asset('assets/img/footer/footer-cta-bg.png')); ?>">
                        <div class="row g-4 align-items-center">
                            ...
                            <div
                                ...
                                <a href="<?php echo e(url('/contact')); ?>#booking" class="vs-btn style6">
                ...
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <div class="footer-widgets">
                        <a href="<?php echo e(url('/')); ?>" class="logo-footer">
                            <img src="<?php echo e(asset('assets/img/logo-bg-wide-white.webp')); ?>"
                        ...
                        <div class="social-media">
                            <ul class="custom-ul">
                                ...
                                <li><a href="#" target="_blank" rel="noopener noreferrer"
                                        aria-label="Follow Morocco Quest on YouTube">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="newsletter">
                            <form action="<?php echo e(route('newsletter.subscribe')); ?>" method="POST" class="w100">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="footer-widgets">
                        ...
                        <div class="instagram">
                            <a href="https://www.instagram.com/moroccoquestdmc/" target="_blank"
                                ...
                                <img src="<?php echo e(asset('assets/img/Desert-Camp-Morocco-Sunset-View-Lanterns-Palm-Trees.webp')); ?>"
                            ...
                            <a href="https://www.instagram.com/moroccoquestdmc/" target="_blank"
                                ...
                                class="instagram-post">
                                <img src="<?php echo e(asset('assets/img/Luxury-Dinner-Setup-Wedding-Morocco-Outdoor-Event.webp')); ?>"
                            ...
                            <a href="https://www.instagram.com/moroccoquestdmc/" target="_blank"
                                ...
                                class="instagram-post">
                                <img src="<?php echo e(asset('assets/img/Moroccan-Gate-Fes-Tourists-Decorative-Architecture.webp')); ?>"
                            ...
                            <a href="https://www.instagram.com/moroccoquestdmc/" target="_blank"
                                ...
                                class="instagram-post">
                                <img src="<?php echo e(asset('assets/img/Moroccan-Palace-Restaurant-Elegant-Dining-Setup.webp')); ?>"
                            ...
                            <a href="https://www.instagram.com/moroccoquestdmc/" target="_blank"
                                ...
                                class="instagram-post">
                                <img src="<?php echo e(asset('assets/img/Moroccan-Riad-Pool-Night-View-Arch-Design.webp')); ?>"
                            ...
                            <a href="https://www.instagram.com/moroccoquestdmc/" target="_blank"
                                ...
                                class="instagram-post">
                                <img src="<?php echo e(asset('assets/img/Traditional-Moroccan-Dining-Event-Outdoor-Lanterns.webp')); ?>"
            ...
            <div class="row">
                <div class="col-md-6 order-2 order-md-1">
                    <p class="footer-copyright text-center text-md-start">
                        © <?php echo e(date('Y')); ?> Morocco Quest — All rights reserved.<br>
                        Développé par
                ...
                <div class="col-md-6 order-1 order-md-2">
                    <div class="footer-menu">
                        <ul class="custom-ul justify-content-center justify-content-md-end">
                            ...
                            <li><a href="<?php echo e(route('terms.conditions')); ?>">Terms</a></li>
...
<?php /**PATH C:\Users\ASUS\Desktop\Projects\public_html\resources\views/partials/footer.blade.php ENDPATH**/ ?>